// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real HIU WorkSpace mark
...
test("boot splash shows the HIU WorkSpace star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting HIU WorkSpace|Restoring your session/)).toBeVisible();
});
