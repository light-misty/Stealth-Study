...
// reads as a screenshot of Slack), StealthStudy on the right (app tokens). Tabs
...
function SlackRail({ active }: { active: string }) {
  return (
    <div className="hiw-slrail">
      ...
      <div className="hiw-slnav"><span className="hiw-appav">SS</span>StealthStudy</div>
    </div>
  );
}
  ...
  return (
    <div className="hiw-win hiw-ow">
      <div className="hiw-owtop">
        <span className="hiw-dots"><i /><i /><i /></span> StealthStudy
      </div>
...
function OwRail({ hot, hotSub, glow }: { hot?: string; hotSub?: string; glow?: boolean }) {
  return (
    <div className="hiw-owrail">
      <div className="hiw-brand">StealthStudy</div>
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@StealthStudy</span> {tr("slack.hiw_summarize")}
            </Msg>
          </div>
          ...
          <div className="hiw-slthread hiw-k" style={d("5.1s")}>
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="SS" avBg="#4a154b" name="StealthStudy" app ts="6:34 PM">
          ...
          <div className="hiw-slthread">
            ...
            <div className="hiw-tmsgs">
              ...
              <Msg av="P" avBg="#7c6cd0" name="Priya N" ts="6:36 PM" delay=".8s">
                <span className="hiw-men">@StealthStudy</span> {tr("slack.hiw_break_country")}
              </Msg>
              <Msg av="SS" avBg="#4a154b" name="StealthStudy" app ts="6:36 PM" delay="4.8s">
      ...
      <SlackWin>
        ...
        <div className="hiw-slmain">
          ...
          <div className="hiw-slmsgs">
            ...
            >
              <span className="hiw-men">@StealthStudy</span> {tr("slack.hiw_pull_numbers")}
            </Msg>
          </div>
          <SlackComposer placeholder={tr("slack.hiw_msg_launch")} />
        </div>
