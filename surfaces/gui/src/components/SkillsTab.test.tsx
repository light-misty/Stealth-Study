...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with Stealth Study hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with Stealth Study"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask Stealth Study to revise")).toBeNull();
