  ...
  if (booting || !uiReady) {
    return (
      <div className={"app boot-splash" + (overlay ? " tauri-overlay" : "")}>
        ...
        {overlay && (
          <div className="titlebar-drag" data-tauri-drag-region>
            <span className="titlebar-brand brand-wordmark">
              <Icon name="logo" size={13} className="mark" /> HIU WorkSpace<span className="beta-tag">BETA</span>
            </span>
          </div>
        )}
        {simOverlay && (
        ...
        {/* The real HIU WorkSpace mark (6-point star, same as the app/tray icon) — the old
