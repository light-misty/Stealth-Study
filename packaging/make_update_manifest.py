...
uploads):
    ...
    HIUWorkSpace-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    HIUWorkSpace-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    HIUWorkSpace-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
The desktop app finds this file through https://hiuworkspace.com/latest.json
...
ARTIFACTS = {
    "HIUWorkSpace-macos-arm64.app.tar.gz": "darwin-aarch64",
    "HIUWorkSpace-macos-x64.app.tar.gz": "darwin-x86_64",
    "HIUWorkSpace-windows-setup.exe": "windows-x86_64",
}
