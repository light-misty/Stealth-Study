...
uploads):
    ...
    StealthStudy-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    StealthStudy-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    StealthStudy-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
The desktop app finds this file through https://download.stealthstudy.com/latest.json
