...
# hiu-workspace-server directly, and the Tauri desktop shell falls back to it when
...
echo "Ready: $VENV"
echo "  server: $VENV/bin/hiu-workspace-server --cwd /path/to/your/project --port 8765"
