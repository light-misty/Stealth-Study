...
"""PyInstaller spec for the bundled `hiu-workspace-server` (desktop sidecar).
...
# Onedir: dist/hiu-workspace-server/{hiu-workspace-server[.exe], _internal/}. The build scripts stage
