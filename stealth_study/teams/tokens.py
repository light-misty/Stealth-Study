...
CLI, a headless Stealth Study, the `ocw` CLI from a second machine) presents the token
...
_TOKEN_PREFIX = "owb_"  # Stealth Study board — greppable in configs, meaningless to guess
