...
class ConnectorDescriptor:
    ...
    risk_notice: str = ""
    # One-click managed OAuth via Stealth Study Cloud (requires cloud sign-in).
...
DESCRIPTORS: list[ConnectorDescriptor] = [
    ...
    ConnectorDescriptor(
        ...
        title="Slack",
        icon="💬",
        blurb="Two-way messaging — one-click via Stealth Study Cloud, or a manual Slack app (Socket Mode).",
        auth="socket_app",
        two_way=True,
        channels=True,
        brand_color="#611f69",
    ...
    ConnectorDescriptor(
        ...
        instructions=[
            "One click connects via Stealth Study Cloud (recommended).",
