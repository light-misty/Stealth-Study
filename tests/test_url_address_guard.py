...
from stealth_study.web import guard
from stealth_study.web.fetch import make_web_fetch_tool
...
def _refusal(requested, final):
    from stealth_study.connectors.browser_automation import redirect_refusal
...
def _open_url_with(monkeypatch, page):
    from stealth_study.connectors import browser_automation as ba
