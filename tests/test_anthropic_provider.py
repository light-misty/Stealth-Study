...
from stealth_study.providers import AnthropicProvider, capabilities_for
from stealth_study.providers.anthropic_provider import (
    DEFAULT_MAX_TOKENS,
    convert_messages,
    convert_tools,
)
...
def test_resolve_api_key_env_then_secrets(monkeypatch):
    from stealth_study.providers.anthropic_provider import resolve_api_key
...
def test_thinking_defaults_on_with_hidden_profile_override():
    ...
    from stealth_study.providers.anthropic_provider import DEFAULT_THINKING_BUDGET
    from stealth_study.providers.registry import build_provider_client
