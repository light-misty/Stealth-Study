...
class ConnectorDescriptor:
    ...
    risk_notice: str = ""
    # One-click managed OAuth via HIU WorkSpace Cloud (requires cloud sign-in).
...
DESCRIPTORS: list[ConnectorDescriptor] = [
    ...
    ConnectorDescriptor(
        ...
        title="Slack",
        icon="💬",
        blurb="Two-way messaging — one-click via HIU WorkSpace Cloud, or a manual Slack app (Socket Mode).",
        auth="socket_app",
        two_way=True,
        channels=True,
        brand_color="#611f69",
    ...
    ConnectorDescriptor(
        ...
        instructions=[
            "One click connects via HIU WorkSpace Cloud (recommended).",
...
# entirely (see packaging/hiu-workspace-server.spec). When the package is absent this is a no-op.
try:
